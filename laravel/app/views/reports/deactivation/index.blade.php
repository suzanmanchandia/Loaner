@section('jumbotron')
{{ View::make('utils.jumbotron', array('class' => 'kits', 'title' => 'Reports', 'subtitle' => 'Deactivation Report')) }}
@stop
    ...
    <div class="col-md-9">
        ...
        <div class="tab-content">
            <div class="tab-pane fade" id="week">
                @include('reports.deactivation.tab', $week)
            </div>
            <div class="tab-pane fade" id="month">
                @include('reports.deactivation.tab', $month)
            </div>
            <div class="tab-pane fade" id="year">
                @include('reports.deactivation.tab', $year)
            </div>
            <div class="tab-pane fade in active" id="custom">
                @include('reports.deactivation.tab', $custom)
            </div>
        </div>
        @else
        <ul class="nav nav-tabs" role="tablist">
