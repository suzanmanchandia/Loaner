{{ Form::model($loan, array('route' => array('reservations.issue', $loan->lid), 'method' => 'put', 'class' => 'form-horizontal form-ajax', 'data-toggle' => 'validator', 'data-refresh' => 'true' ) ) }}
<fieldset>
...
<script>
    ...
    $('.unique-equipment').keydown(function(event){
        if(event.keyCode == 13) {
