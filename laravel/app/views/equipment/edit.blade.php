@section('jumbotron')
{{ View::make('utils.jumbotron', array('class' => 'kits', 'title' => link_to_route('equipment.index', 'Equipment'), 'subtitle' => 'Edit Equipment' )) }}
@stop

@section('content')
{{ Form::model( $equipment, array('route' => array('equipment.update', $equipment->equipmentid), 'method' => 'put', 'class' => 'form-horizontal form-ajax', 'data-toggle' => 'validator', 'data-redirect' => route('equipment.index') ) ) }}
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                {{ Form::text('equipmentid', $equipment->equipmentid, array('class' => 'form-control', 'id' => 'equipment-id', 'maxlength' => 15, 'disabled' ) ) }}
            </div>
        </div>
