{{ Form::model( $kit, array('route' => array('kits.deactivate', $kit->kitid), 'method' => 'delete', 'class' => 'form-horizontal form-ajax', 'data-toggle' => 'validator', 'data-redirect' => route('kits.index') ) ) }}
<fieldset>
