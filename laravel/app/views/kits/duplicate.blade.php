@section('jumbotron')
{{ View::make('utils.jumbotron', array('class' => 'kits', 'title' => link_to_route('kits.index', 'Kits'), 'subtitle' => 'Duplicate Kit #'.$kit->kitid )) }}
@stop

@section('content')
{{ Form::model( $kit, array('route' => array('kits.store'), 'class' => 'form-horizontal form-ajax', 'data-toggle' => 'validator', 'data-redirect' => route('kits.index') ) ) }}
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
            {{ Form::text('kitid', $kit->suggestId($deptID), array('class' => 'form-control', 'id' => 'kit-id', 'required' ) ) }}
            <span class="help-block with-errors">Autogenerated id (Original: {{{ $kit->kitid }}} )</span>
            </div>
        </div>
